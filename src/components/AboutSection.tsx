      ...
      <div className="container mx-auto px-4 md:px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="relative flex justify-center lg:justify-start">
          ...
          <div className="relative grid grid-cols-2 gap-3 items-center">
            ...
            <div
              className="absolute bottom-4 right-6 w-14 h-14 rounded-full flex items-center justify-center shadow-xl"
        ...
        <div>
          ...
          <div className="mt-10 flex flex-col sm:flex-row items-center gap-6">
            ...
            <div className="flex items-center gap-4">
              <span className="text-sm font-medium text-gray-700">Established in <strong>2019</strong></span>
