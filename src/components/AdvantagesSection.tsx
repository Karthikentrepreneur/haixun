    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-4">
            ...
            return (
              <ScrollAnimation key={index} delay={index * 100}>
                <motion.div
                  ...
                  className="bg-white border border-gray-100 shadow-sm hover:shadow-md transition-all duration-300 rounded-2xl p-8 w-full max-w-[380px] text-center"
                >
        ...
        <div className="text-center mt-14">
          <button className="px-8 py-3 rounded-full border border-red-500 text-red-600 font-medium hover:bg-red-500 hover:text-white transition-all duration-300 shadow-sm">
            {t("advantages.cta")}
          </button>
        </div>
      </div>
